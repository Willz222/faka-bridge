...
const migrationPath = resolve(projectRoot, "dist/migrations/0005_selective_catalog_acg_to_acg.sql");
...
assert.match(migration, /ADD COLUMN published/);
assert.match(migration, /bridge_orders_v6/);
assert.match(migration, /bridge_orders_next_request_unique/);
assert.match(migration, /bridge_orders_acg_request_unique/);
