...
export const tables = {
  ...
  bridgeOrders: ["id", "direction", "downstream_order_no", "status", "connection_id", "upstream_platform", "submission_state", "upstream_cost", "upstream_currency"],
  callbackEvents: ["event_id", "order_id", "source"],
  auditLogs: ["action", "order_id", "result", "created_at"],
  upstreamConnections: ["id", "name", "platform", "base_url", "health_status", "sync_interval_minutes", "balance", "balance_currency"],
